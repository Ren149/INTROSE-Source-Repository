...
public class ProductManager {
	...
	public float getSellingPrice(int productID) {
		...
		ResultSet rs;
		String sQuery = "SELECT selling_price " + "FROM products " + "WHERE productID = '" + productID + "';";
	...
	public String getProductName(int productID) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT product_name " + "FROM products " + "WHERE productID = '" + productID + "';";
	...
	public int getProductID(int row, String searchText) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT p.productID " + "FROM products p " + "WHERE p.product_name LIKE '%" + searchText + "%' "
				+ "AND p.isDiscontinued = false " + "ORDER BY p.product_name LIMIT 1 OFFSET " + row + ";";
		int productID = -1;
	...
	public ArrayList<Integer> getProductIDList(String searchText) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT productID FROM products WHERE isDiscontinued = false AND product_name LIKE '%"
				+ searchText + "%' ORDER BY product_name;";
		ArrayList<Integer> productIDList = new ArrayList<>();
	...
	public ArrayList<Integer> getProductIDList(int month) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT DISTINCT b.productID " + "FROM products p, batch b " + "WHERE p.isDiscontinued = false "
	...
	public boolean checkDuplicates(String productname) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT product_name " + "FROM products	" + "WHERE product_name = ?;";
	...
	public void addProduct(String productName, float sellprice) {
		...
		if (productID == -1) {
			sQuery = "INSERT INTO products(product_name, selling_price, isDiscontinued) " + "VALUES('" + productName
					+ "', '" + sellprice + "', '0');";
	...
	public void restockProduct(String productname, float sellprice, int productID) {
		DBConnection con = new DBConnection();
		PreparedStatement ps;
		String sQuery = "UPDATE products " + "SET product_name = '" + productname + "', selling_price = '" + sellprice
	...
	public boolean isDiscontinued(int productID) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT isDiscontinued " + "FROM products	" + "WHERE productID = " + productID + ";";
	...
	public void setDiscontinued(int productID, boolean discontinue) {
		...
		if (discontinue) {
			sQuery = "UPDATE products " + "SET isDiscontinued = '1' " + "WHERE productID = '" + productID + "';";
		} else {
			sQuery = "UPDATE products " + "SET isDiscontinued = '0' " + "WHERE productID = '" + productID + "';";
		}
	...
	public void setSellingPrice(int productID, float sellingPrice) {
		DBConnection con = new DBConnection();
		PreparedStatement ps;
		String sQuery = "UPDATE products " + "SET selling_price = '" + sellingPrice + "' " + "WHERE productID = '"
				+ productID + "';";
