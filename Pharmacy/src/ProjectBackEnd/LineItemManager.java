...
public class LineItemManager {
	...
	public void recordTransaction(int salesID, int productID, int totalQty, float unit_price, float total_price_sold) {
		...
		String sQuery = "INSERT INTO line_item(salesID, productID, quantity_sold, unit_price, total_price_sold) "
				+ "VALUES('" + salesID + "','" + productID + "', '" + totalQty + "', '" + unit_price + "', '"
				+ total_price_sold + "')";
	...
	public String determineDemand(int productID) {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT SUM(quantity_sold) " + "FROM line_item " + "WHERE productID = '" + productID + "' ;";
		String demand = "";
	...
	public ArrayList<Integer> getProductIDs() {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT DISTINCT(l.productID) " + "FROM line_item l, products p "
				+ "WHERE l.productID = p.productID " + "ORDER BY p.product_name;";
	...
	private ArrayList<Integer> getTotalSaleCountList() {
		...
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT SUM(quantity_sold) " + "FROM line_item " + "GROUP BY productID;";
