...
public class ReorderPointPanel extends JFrame implements ActionListener{
	...
	public ReorderPointPanel() {
		...
		getContentPane().setLayout(new MigLayout("", "[][grow][]", "[][][][][][grow 50]"));
		
		//HEADER
		lblReorderPointHeader.setFont(new Font("Segoe UI", Font.BOLD, 11));
		getContentPane().add(lblReorderPointHeader, "cell 0 0");
		...
		getContentPane().add(txtSlowMovingItemPoint, "cell 1 1,growx");
		txtSlowMovingItemPoint.setColumns(10);
		
		lblSlowPieces.setFont(new Font("Segoe UI", Font.PLAIN, 10));
		getContentPane().add(lblSlowPieces, "cell 2 1,alignx left");
		...
		getContentPane().add(txtFastMovingItemPoint, "cell 1 3,growx,aligny top");
		txtFastMovingItemPoint.setColumns(10);
		
		lblFastPieces.setFont(new Font("Segoe UI", Font.PLAIN, 10));
		getContentPane().add(lblFastPieces, "cell 2 3");
		...
		getContentPane().add(btnAdjustReorderPoint, "cell 2 5,aligny bottom");
	}
