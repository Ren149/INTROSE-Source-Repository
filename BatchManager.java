...
public class BatchManager {
	...
	public float getLatestBuyingPrice(int batchID) {
		PreparedStatement ps;
		ResultSet rs;
		String sQuery = "SELECT buying_price "
				+ "FROM batch "
	...
	{	
		...
		String sQuery = "SELECT batchID FROM batch WHERE productID = ?;";
	...
	public void restockBatch(int batchquantity, double buyingprice, int expiremonth, int expiryyear, int productID) {
		...
		String sQuery = "INSERT INTO batch(productID, total_batch_quantity, expiry_month, expiry_year, entry_date, buying_price) "
					+ "VALUES('" + productID + "','"+ batchquantity +"','"+ batchquantity +"','"+ expiremonth +"','"+ expiryyear +"', CURDATE(), '"+ buyingprice + "') ";
